...
/* package symptom-checker-0.1.0.0 */
#ifndef VERSION_symptom_checker
#define VERSION_symptom_checker "0.1.0.0"
#endif /* VERSION_symptom_checker */
#ifndef MIN_VERSION_symptom_checker
#define MIN_VERSION_symptom_checker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_symptom_checker */
...
#define CURRENT_COMPONENT_ID "symptom-checker-0.1.0.0-inplace-symptom-checker"
